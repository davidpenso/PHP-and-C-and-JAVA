...
public class sfj {
	...
	public static void main(String[] args) {
		...
		sfjAlgorithm(schedule, scanedRand);
	...
	public static void sfjAlgorithm(scheduler sc,Scanner scan){
		...
		while(todo>0){
			...
			//System.out.println("process size:"+procList.size());
			//System.out.println("process size:"+procList.get(1));
			...
			//sortCPUTime(procList);
			
			for(int i=0;i<procList.size();i++){
				scheduler.enqueue(procList.get(i));
			}
			scheduler.sortCPUTime(scheduler.queue);
